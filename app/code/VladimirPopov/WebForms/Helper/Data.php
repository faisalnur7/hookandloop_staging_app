...
class Data extends AbstractHelper
{
    ...
    final function verifyIpMask($data, $checkstr)
    {
        if (!is_array($data)) {
            $data = array($data);
        }
    ...
    final public function isProduction()
    {
        ...
        $checkstr = strtolower(str_replace(array(" ", "-"), "", (string)$serial));
    ...
    public function isInEmailStoplist($email)
    {
        ...
        foreach ($stoplist as $blocked_email) {
            $pattern = trim((string)$blocked_email);
