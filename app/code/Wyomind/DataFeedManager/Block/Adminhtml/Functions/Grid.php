...
{
    /**
     * @var \Wyomind\DataFeedManager\Model\ResourceModel\Functions\CollectionFactory
     */
    ...
    {
        $this->addColumn('script', ['header' => __('Script'), 'align' => 'left', 'index' => 'script', 'filter' => false]);
