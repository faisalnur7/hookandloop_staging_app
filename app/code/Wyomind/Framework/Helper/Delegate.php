 ...
 */
namespace Wyomind\Framework\Helper;  class Delegate extends \Wyomind\Framework\Helper\License {public $x20c23=null;public $x1c3d6=null;public $x703ef=null; const VERSION = "\67.\62\x2e\71"; public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, \Magento\Framework\App\Helper\Context $context) { parent::__construct($objectManager, $context); $this->constructor($this, func_get_args(), __CLASS__); } protected function getDelegation() { ${$this->x1c3d6->xfb->{$this->x703ef->xfb->{$this->x703ef->xfb->x220}}} = "\\"; return [ ]; } }
