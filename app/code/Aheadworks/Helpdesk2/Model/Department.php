...
class Department extends AbstractModel implements DepartmentInterface
{
     ...
     * @return int|null
     */
    public function getEmailToSendFrom(): string
    {
        return (string)$this->getData(self::EMAIL_TO_SEND_FROM);
    }

    /**
     * Set send as agent
     *
     * @param string|null $emailToSendFrom
     * @return $this
     */
    public function setEmailToSendFrom(?string $emailToSendFrom = null): DepartmentInterface
    {
        return $this->setData(self::EMAIL_TO_SEND_FROM, $emailToSendFrom);
    }
