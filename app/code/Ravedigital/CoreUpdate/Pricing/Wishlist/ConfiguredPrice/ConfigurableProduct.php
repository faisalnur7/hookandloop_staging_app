 ...
 */
namespace Ravedigital\CoreUpdate\Pricing\Wishlist\ConfiguredPrice;
...
class ConfigurableProduct extends AbstractPrice
{
    ...
    public function getValue()
    {
        ...
        $product = $customOption ? $customOption->getProduct() : $this->getProduct();
        $measurementSold = 1;
        $measurementSold = $product->getMeasurementSoldInSize();
        $price = ($product->getPriceInfo()->getPrice(self::PRICE_CODE)->getValue()) * $measurementSold;
