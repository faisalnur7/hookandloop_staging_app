...
class AroundGetOptionPrice
{
    ...
    protected function getOptionPriceAsString($model, $qty)
    {
        ...
        //$price *= $qty/$product->getMeasurementSoldInSize();
        $price =0;
        if (!$price) {
            return '';
        }
    ...
    protected function getChargableOptionPrice($price, $qty, $measurement_sold_in_size)
    {
        return $price * $qty/$measurement_sold_in_size;
    }
