<?php
namespace Aheadworks\Helpdesk2\Model\Ticket\Detector\Type\NewTicket;
 ...
 * Class EventTrigger
 *
 * @package Aheadworks\Helpdesk2\Model\Ticket\Detector\Type\NewTicket
 */
        ...
        switch ($message->getType()) {
            case MessageType::CUSTOMER:
                $this->eventManager->dispatch(
                    Event::EVENT_NAME_PREFIX . Event::NEW_TICKET_FROM_CUSTOMER,
                    $eventData
                );
                break;
            case MessageType::ADMIN:
                $this->eventManager->dispatch(
                    Event::EVENT_NAME_PREFIX . Event::NEW_TICKET_FROM_AGENT,
                    $eventData
                );
                break;
        }
