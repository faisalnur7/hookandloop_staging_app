 ...
 */
namespace Ravedigital\CoreUpdate\Model\ConfigurableProduct\ResourceModel\Indexer\Stock;
...
class Configurable extends \Magento\ConfigurableProduct\Model\ResourceModel\Indexer\Stock\Configurable
{
    ...
    protected function _getStockStatusSelect($entityIds = null, $usePrimaryTable = false)
    {
        ...
        $optExpr = $connection->getCheckSql("le.required_options = 1 OR le.required_options = 0", 'i.stock_status', 0);
