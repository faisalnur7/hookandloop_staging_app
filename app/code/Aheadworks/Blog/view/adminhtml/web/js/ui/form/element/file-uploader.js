define([
    ...
    return fileUploader.extend({
        ...
        loadImageForPreview: function (encodedUrl) {
            ...
            try {
                if (encodedUrl.indexOf('___directive') === -1) {
                    ...
                    if (file.path.indexOf('media') != -1) {
                        file.path = this.getFilePath(file.path);
                    }
         ...
         * @param {string} imagePath
         */
        getFilePath: function (imagePath) {
            var pos = imagePath.indexOf('wysiwyg');
            if (pos != -1) {
                return imagePath.substr(pos);
            }
