    ...
    function ($, Component, ko) {
        ...
        return Component.extend({
            ...
            getInitialCollapseState: function () {
                console.log(window.checkoutConfig.comment_initial_defualt_show);
            ...
            getCheckouttitle: function () {
                console.log($.mage.__(window.checkoutConfig.checkout_title));
                return $.mage.__(window.checkoutConfig.checkout_title);
            },
            isEnable: function () {
                console.log(window.checkoutConfig.is_ordercomment_enable);
