...
class Network extends AbstractHelper
{
    ...
    /**
     * Get button config class name.
     *
     * @param string $networkCode
     * @return string
     */
    public function getButtonResolverClass(string $networkCode): string
    {
        return (string) $this->networkXmlConfig->get("$networkCode/button/resolver");
    }
     ...
     * @return string
     */
    public function getTitle(string $networkCode): string
    {
        return ((string) $this->networkXmlConfig->get("$networkCode/title")) ?: ucfirst($networkCode);
    }
    ...
    /**
     * Get profile url resolver.
     *
     * @param string $networkCode
     * @return string
     */
    public function getProfileUrlResolver(string $networkCode): string
    {
        return (string) $this->networkXmlConfig->get("$networkCode/profile/resolver");
    }
}
