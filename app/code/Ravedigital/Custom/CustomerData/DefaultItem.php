...
namespace Ravedigital\Custom\CustomerData;
...
class DefaultItem extends \Magento\Checkout\CustomerData\DefaultItem
{
    ...
    protected function doGetItemData()
    {
        ...
        return [
            ...
            'measurement_sold_in_unit' => $this->getMeasurementSize(),
            'product_type' => $this->item->getProductType(),
    ...
    protected function getMeasurementSize()
    {
        $product = $this->item->getProduct();
        $product_type = $this->item->getProductType();
        if ($product_type == 'configurable') {
            $options = $this->item->getOptionByCode('simple_product');
            $product = $options->getProduct();
            $productId = $options->getProduct()->getId();
    
           //$productId = $this->item->getProduct()->getId();
       
            return $product->getMeasurementSoldInSize();
        } else {
            return $this->item->getProduct()->getMeasurementSoldInSize();
        }
    }
}
