...
class Action implements OptionSourceInterface
{
    ...
    public function toOptionArray()
    {
        return [
            ...
            [
                'value' => self::RATING_CHANGE,
                'label' => __('Display Rating Change Message in Admin Ticket Thread')
            ]
        ];
    }
    ...
    public function getAvailableOptionsByEventType()
    {
        ...
        return [
            ...
            Event::TICKET_RATING_CHANGE => [
                ...
                [
                    'label' => $options[self::RATING_CHANGE],
                    'value' => self::RATING_CHANGE
                ]
            ]
        ];
    ...
    public function getAvailableConfigTypesByEventType()
    {
        ...
        return [
            ...
            Event::ORDER_CREATED => $storeConfig,
            Event::TICKET_STATUS_CHANGE => $storeConfig,
            Event::TICKET_RATING_CHANGE => $storeConfig,
        ];
    }
}
