        ...
        if ($this->getRequest()->isPost()) {
            ...
            if (!empty($login['username']) && !empty($login['password'])) {
                try {
                    ...
                    if($this->customerAccountManagement->isEmailAvailable($login['username'],1)){
                        $message = __(
                            'There is no account associated with this email. Can you please register with us or checkoout as a guest?'
                        );
                    } else {
                        /*$message = __(
                        ...
                        $message = __(
                            'The account sign-in was incorrect or your account password is incorrect. Can you please click on forgot password and reset your password?'
                        );
                    }
