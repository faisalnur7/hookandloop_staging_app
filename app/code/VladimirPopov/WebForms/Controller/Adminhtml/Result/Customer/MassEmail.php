    ...
    public function execute(): Json
    {
        ...
        try {
            ...
            foreach ($collection as $result) {
                $this->resultRepository->getById($result->getId())->sendEmail($recipient, $contact);
            }

            $message = __('A total of %1 record(s) have been emailed.', $collectionSize);
            ...
            $message = __('We can\'t mass email the results right now.');
            $error = true;
        }
