...
define(
   ...
   var mixin = {
       ...
       validateCustomFieldsShipping: function () {
           ...
           if (this.source.get('shippingAddress.shippingoptions') && shippingMethod == "shippingoptions_shippingoptions") {
               this.source.set('params.invalid', false);
               this.source.trigger('shippingAddress.shippingoptions.data.validate');
