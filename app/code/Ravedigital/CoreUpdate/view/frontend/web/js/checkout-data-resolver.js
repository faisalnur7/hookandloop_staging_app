    ...
    return {
        ...
        resolveShippingRates: function (ratesData) {
            ...
            for (var i = 0;i < ratesData . length;i++){
                if (ratesData[i] . method_code == 'freeshipping') {
                ...
                else if (ratesData[i] . method_code == '03') {
                    if(document.getElementById("s_method_ups_03") !== null) {
                        document.getElementById("s_method_ups_03").click();
                    ...
                    selectShippingMethodAction(ratesData[i]);
                    return;
                }/*else if (ratesData[i] . method_code == 'shippingoptions') {
                    selectShippingMethodAction(ratesData[i]);
                    return;
                }*/
            }
