...
class ValueMapper
{
    ...
    public function __construct(
        ...
        CustomerRatingSource $customerRatingSource,
        ...
        $this->customerRatingSource = $customerRatingSource;
    ...
    public function getAvailableConditionValuesByConditionType()
    {
        $values = [
            ...
            Condition::TICKET_STATUS_CHANGE => [
                'type' => self::MULTISELECT,
                'options' => $this->ticketStatusSource->toOptionArray()
            ],
            Condition::TICKET_RATING_STATUS_CHANGE => [
                'type' => self::MULTISELECT,
                'options' => $this->ticketStatusSource->toOptionArray()
            ],
            Condition::TICKET_RATING => [
                'type' => self::MULTISELECT,
                'options' => $this->customerRatingSource->toOptionArrayAddNone()
            ],
            Condition::TICKET_RATING_CHANGE => [
                'type' => self::MULTISELECT,
                'options' => $this->customerRatingSource->toOptionArray()
            ],
            Condition::TICKET_TAG => [
                'type' => self::MULTISELECT,
                'options' => $this->tagsSource->toOptionArray()
            ],
            Condition::PRODUCT_SKU => [
                'type' => self::PRODUCT_SKU
            ]
        ];
