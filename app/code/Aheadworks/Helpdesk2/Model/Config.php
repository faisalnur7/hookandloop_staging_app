...
class Config
{
    ...
    const XML_PATH_BACKEND_TICKET_PAGE_TICKET_VIEW_DEFAULT_TAB =
        'aw_helpdesk2/backend_ticket_page/ticket_view_default_tab';
    ...
    /**
     * Get ticket view default tab
     *
     * @param int|null $storeId
     * @return string
     */
    public function getTicketViewDefaultTab($storeId = null): string
    {
        return $this->scopeConfig->getValue(
            self::XML_PATH_BACKEND_TICKET_PAGE_TICKET_VIEW_DEFAULT_TAB,
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
