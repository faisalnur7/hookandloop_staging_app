...
namespace Dckap\CustomFields\Block;
...
class Review extends \Magento\Paypal\Block\Express\Review{
    ...
    public function getShippingOptionsMethod(){
        return $this->_quote->getShippingOptionsMethod();
    }

    public function getShippingOptionsService(){
        return $this->_quote->getShippingOptionsService();
    }

    public function getShippingOptionsAccountNumber(){
        return $this->_quote->getShippingOptionsAccountNumber();
    }

    public function getShippingOptionsAccountZipCodes(){
        return $this->_quote->getShippingOptionsAccountZipCodes();
    }
