...
class PeriodicalReport
{
    ...
    public function __construct(
        \Wyomind\Watchlog\Helper\Delegate $wyomind,
        /** @delegation off */
    ...
    {
        try {
            $emails = explode(',', (string) $this->_watchlogHelper->getDefaultConfig('watchlog/periodical_report/emails'));
