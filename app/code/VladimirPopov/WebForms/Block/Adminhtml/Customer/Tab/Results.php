...
/**
 * Class Results
 * @package VladimirPopov\WebForms\Block\Adminhtml\Customer\Tab
 * @deprecated Replaced with UI view\adminhtml\ui_component\customer_result_listing.xml
 */
class Results extends \Magento\Backend\Block\Widget\Grid\Extended implements TabInterface
{
    ...
    {
        return $this->_coreRegistry->registry(RegistryConstants::CURRENT_CUSTOMER_ID)?:$this->getRequest()->getParam('customer_id');
    }
    ...
    {
        return $this->getUrl('webforms/customer/results', array('customer_id' => $this->getCustomerId()));
    }
